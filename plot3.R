...
plot(epochT, s1, ylab="", xlab="", ylim=c(0,30),type="l", axes=FALSE)
par(new=TRUE)
plot(epochT, s3, ylab="", xlab="", ylim=c(0,30), type="l", axes=FALSE, col='blue')
par(new=TRUE)
plot(epochT, s2, ylab="Energy sub metering", xlab="", ylim=c(0,30), type="l", axes=FALSE, col='red')
par(new=TRUE)
